...
import com.runiverse.running_service.application.auth.exception.InvalidCredentials;
...
public class LoginHandler implements LoginUsecase {
    ...
    public LoginResult handle(LoginCommand command) {
        ...
        if (foundUser.isEmpty()) throw new InvalidCredentials();
        ...
        if (!passwordChecked) throw new InvalidCredentials();
